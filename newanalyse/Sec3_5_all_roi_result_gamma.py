...
def main():
    ...
    batch_root = str(get_within_decoding_batch_dir(BASE_PATH, 'gamma', SUBJECT, batch_name=BATCH_NAME))
...
def build_task2_gray_memory_combos(mat):
    if 'g_task2' not in mat:
        raise ValueError('Missing matrix: g_task2')
    data = mat['g_task2']
    gray_green = [2, 5]
    gray_red = [8, 11]
